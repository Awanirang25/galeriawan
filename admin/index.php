...
<body>
 ...
 <div class="container mt-2">
  <div class="row">
    <?php
    $query = mysqli_query($koneksi, "SELECT * FROM foto INNER JOIN user1 ON foto.userid=user1.userid INNER JOIN album ON foto.albumid=album.albumid");
    while($data = mysqli_fetch_array($query)){
      ...
      <div class="col-md-3">
        <a type="button" data-bs-toggle="modal" data-bs-target="#komentar<?php echo $data['fotoid'] ?>">
          ...
          <div class="card mb-2">
            <img  src="../assets/img/<?php echo $data['lokasifile'] ?>" class="card-img-top" title="assets/img/<?php echo $data['judulfoto'] ?>" style="height: 12rem;">
                  ...
                  <div class="col-md-4">
                    <div class="m-2">
                      <div class="overflow-auto">
                       ...
                       <?php 
                       $fotoid = $data['fotoid'];
                       $komentar = mysqli_query($koneksi,"SELECT * FROM komentarfoto INNER JOIN user1 ON komentarfoto.userid=user1.userid WHERE komentarfoto.fotoid='$fotoid'");
